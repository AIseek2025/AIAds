...
/** POST /api/v1/advertisers/me/recharge 非法 body → 422 */
test.describe('Advertiser API recharge validation', () => {
  test('empty body returns 422', async ({ request }) => {
    ...
    const res = await request.post(`${base}/api/v1/advertisers/me/recharge`, {
      data: {},
